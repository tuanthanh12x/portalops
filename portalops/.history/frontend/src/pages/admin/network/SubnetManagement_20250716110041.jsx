    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <div className="px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card>
            <CardContent>
              <CardTitle icon="🔗">Total Subnets</CardTitle>
              <div className="flex items-end gap-2">
                <p className="text-3xl font-bold text-green-400">{subnets.length}</p>
                <span className="text-sm text-green-400 font-medium">+1 today</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent>
              <CardTitle icon="✅">Active Subnets</CardTitle>
              <div className="flex items-end gap-2">
          ...
          <Card>
            <CardContent>
              <CardTitle icon="🌐">DHCP Enabled</CardTitle>
              <div className="flex items-end gap-2">
                <p className="text-3xl font-bold text-blue-400">
                  {subnets.filter(s => s.enable_dhcp).length}
                </p>
                <span className="text-sm text-blue-400 font-medium">auto-config</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent>
              <CardTitle icon="📊">IP Utilization</CardTitle>
              <div className="flex items-end gap-2">
                <p className="text-3xl font-bold text-yellow-400">67%</p>
                <span className="text-sm text-yellow-400 font-medium">capacity</span>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-4 h-4 text-blue-600 bg-gray-700 border-gray-600 rounded focus:ring-blue-500"
            />
            <label htmlFor="edit_enable_dhcp" className="text-sm text-gray-300">
              Enable DHCP
            </label>
          </div>
          ...
          <div className="flex gap-3 pt-4">
            <Button onClick={handleUpdateSubnet} variant="success">
              Update Subnet
            </Button>
            <Button 
