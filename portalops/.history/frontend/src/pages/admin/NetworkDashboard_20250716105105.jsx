                ...
                <tbody>
                  {networks.map((net) => (
                    <tr key={net.id} className="border-b">
                      ...
                      <td className="px-4 py-2">{net.project_id || "-"}</td>
                      <td className="px-4 py-2">{net.shared ? "Yes" : "No"}</td>
                      <td className="px-4 py-2">{net.router_external ? "Yes" : "No"}</td>
                      <td className="px-4 py-2 text-xs break-words">{net.id}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
