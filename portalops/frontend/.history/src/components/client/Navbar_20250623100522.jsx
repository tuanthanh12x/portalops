...
const Navbar = () => {
  ...
  const handleUnimpersonate = async () => {
    try {
      const tokenObj = JSON.parse(localStorage.getItem("accessToken")); // ✅ OK in this case
    ...
    <nav className="sticky top-0 z-50 bg-gray-900 text-gray-100 shadow-lg font-sans">
      <div className="container mx-auto flex justify-between items-center px-6 py-4">
        ...
        <ul className="hidden md:flex md:items-center md:space-x-10 text-lg">
          ...
          <li><a href="/network" className="hover:text-emerald-400 transition font-medium">Network</a></li>
